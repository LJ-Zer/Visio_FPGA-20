...
try:
  ...
  while True:
    ...
    subprocess.run(['git', 'pull', 'origin', 'master'], env={'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': git_token})
    ...
    subprocess.run(['git', 'push', 'origin', 'master'], env={'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': git_token})
